        ...
        changeElementNames: function (element, count, subCount) {
            ...
            element.each(function () {
                ...
                if (typeof name !== 'undefined' && name !== false) {
                    name = self.replaceCounter(/\[([\d]{1,3})\]/g, "[", "]", count, subCount, name);
                    $(this).attr('name', name);
                }

                if (typeof id !== 'undefined' && id !== false) {
                    id = self.replaceCounter(/_([\d]{1,3})[_]*/g, "_", "_", count, subCount, id);
                    $(this).attr('id', id);
                }

                if (typeof obj_id !== 'undefined' && obj_id !== false) {
                    obj_id = self.replaceCounter(/_([\d]{1,3})[_]*/g, "_", "_", count, subCount, obj_id);
